...
class RationCardApp:
    ...
    def create_api_and_upload_section(self):
        ...
        self.gemini_key_entry.insert(0, "") # ضع مفتاحك هنا كافتراضي إن أردت
    ...
    def create_main_layout(self):
        ...
        # زر التصدير والطباعة
        print_btn = tk.Button(self.root, text="تصدير وتجهيز الكرت للطباعة 🖨️", command=self.export_to_html, bg="#0d6efd", fg="white", font=("Segoe UI", 12, "bold"), pady=6)
        print_btn.pack(fill="x", padx=20, pady=15)
    ...
    def add_member_row(self, name="", relationship=""):
        ...
        # حفظ مراجع الحقول للتمكن من قراءتها لاحقاً
        ...
        # تمرير التمرير التلقائي لأسفل السكرول عند إضافة سطر
    ...
    def start_ocr_thread(self):
        """تشغيل المعالجة والذكاء الاصطناعي في Thread خلفي لتجنب تجميد الشاشة"""
    ...
    def process_image_ocr(self, file_path, api_key):
        try:
            ...
            # تنظيف ردود الماركداون إذا وجدت
            ...
            # ملء حقول الواجهة بأمان في الـ Main Thread
    ...
    def fill_fields_from_json(self, data):
        """تعبئة الحقول بالبيانات المستخرجة وتحديث جدول أفراد العائلة"""
    ...
    def export_to_html(self):
        ...
        for idx, row in enumerate(self.member_rows):
            ...
            if name:  # تخطي الأسطر الفارغة تماماً
        ...
        # قالب التصميم المتكامل (HTML + CSS متطور للطباعة والتصميم المنسق)
...
<head>
    ...
    <style>
        ...
        /* الكرت الرئيسي المصمم للطباعة الفائقة */
        .ration-card {{
            background: #ffffff;
        ...
        /* تخطيط شبكة الحقول (مثل كروت الدولة الرسمية) */
        .info-grid {{
            display: grid;
        ...
        /* في حال كان الحقل ثلاثي (مثل السطر الثالث في صورة البطاقة) */
        .triple-grid {{
            display: grid;
        ...
        /* جدول أفراد العائلة (يتمدد للأسفل تلقائياً ليتسع لأي عدد دون اختفاء أي اسم) */
        ...
        /* تخصيص إعدادات الطباعة عند إعطاء أمر الطباعة Ctrl+P */
        @media print {{
            body {{
                background-color: #ffffff;
                padding: 0;
            ...
            /* منع انقسام الأفراد في صفحات مختلفة إذا كان العدد هائل ومناسب لصفحة واحدة */
            .family-table-container {{
...
<body>
    ...
    <div class="ration-card">
        <!-- قسم الهيدر باللوغويات يمين ويسار -->
        <div class="header">
        ...
        <!-- الصف الأول: رقم البطاقة التموينية واسم رب الأسرة -->
        <div class="info-grid">
            <div class="info-box">
        ...
        <!-- الصف الثاني: وكيل الطحين ووكيل الغذائية -->
        <div class="info-grid">
            <div class="info-box">
        ...
        <!-- الصف الثالث: معلومات الموقع الجغرافي والمركز -->
        ...
        <!-- جدول أفراد الأسرة المسجلين (يتمدد بلا حدود ليتسع للجميع) -->
...
'''
        # حفظ الملف في نفس المجلد وفتحه بالمتصفح للطباعة مباشرة
        ...
        try:
            ...
            messagebox.showinfo("تم التصدير", f"تم توليد الكرت بنجاح وحفظه باسم '{output_filename}'.\n\nتم فتح الكرت في المتصفح تلقائياً؛ يمكنك الآن الضغط على (Ctrl + P) لطباعته مباشرة بمقاسات مطابقة وشكل رائع!")
        except Exception as e:
